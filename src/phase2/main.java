...
import phase1.controlleure.enseigcontrolleure;
import phase1.controlleure.etudcontrl;
...
import static phase1.service.configuration.departements;
import static phase1.service.configuration.id_etd;
public class main
{
    ...
    public static void createTabledep(Connection cx) throws SQLException
    {
        ...
        public static void insertDept(Departement departement, Connection cx) throws SQLException
        {
            ...
            ps.setInt(1, configuration.getDept_id());
        ...
        public static void supprimerDept(int id,Connection cx) throws SQLException
{
    ...
    public static List<Departement> getAllDep(Connection cx) throws SQLException
    {
        ...
        while (r.next())
        {
           ...
           String nom=r.getString("nom");
            ...
            Enseignant enseignant = service_enseignant.getEnsgById(idensg);
    ...
    public static void insertEnse(Enseignant enseignant, Connection cx) throws SQLException
    {
        ...
        PreparedStatement ps=cx.prepareStatement(query);
        ps.setInt(1, configuration.getEnsg_id());
    ...
    public static List<Enseignant> getAllEns(Connection cx) throws SQLException {
        ...
        while (r.next()) {
            ...
            Enseignant enseignant = new Enseignant(r.getInt("idens"), r.getString("nom"), r.getString("prenom"), r.getString("email"), r.getString("grade"));
            configuration.enseignants.add(enseignant);
